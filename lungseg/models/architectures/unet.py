...
class UNet(nn.Module):
    ...
    def __init__(self, in_ch=3, out_ch=1, multiclass=False):
        ...
        self.Up5 = UpConvBlock(filters[4], filters[3])
        self.Up_conv5 = ConvBlock(filters[4], filters[3])

        self.Up4 = UpConvBlock(filters[3], filters[2])
        self.Up_conv4 = ConvBlock(filters[3], filters[2])

        self.Up3 = UpConvBlock(filters[2], filters[1])
        self.Up_conv3 = ConvBlock(filters[2], filters[1])

        self.Up2 = UpConvBlock(filters[1], filters[0])
